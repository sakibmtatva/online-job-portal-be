...
export async function PUT(request, { params }) {
  try {
    ...
    return createApiResponse('Failed to mark notification as read', null, 500)
      .response;
  }
}
...
export async function DELETE(request, { params }) {
  try {
    ...
    return createApiResponse('Notification deleted successfully', result, 200)
      .response;
  } catch (error) {
    console.error('Error deleting notification:', error);
    return createApiResponse('Failed to delete notification', null, 500)
      .response;
  }
}
